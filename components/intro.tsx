...
export default function Intro() {
    return (
        <div className="md:sticky top-0 z-10 shrink-0 px-6 md:py-8 py-2 border-b-2 border-b-gray-300 bg-[#f7fafc]">
            <h1 className="text-xl md:text-4xl text-gray-800 font-bold font-sans">Admin Home</h1>
            <p className="md:text-xl text-gray-400 md:mt-4 font-sans whitespace-pre-line">Welcome to your Admin dashboard!</p>
